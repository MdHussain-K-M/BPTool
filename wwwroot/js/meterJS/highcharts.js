...
*/
(function(W, P) {
    "object" === typeof module && module.exports ? (P["default"] = P, module.exports = W.document ? P(W) : P) : "function" === typeof define && define.amd ? define("highcharts/highcharts", function() {
        return P(W)
    }) : (W.Highcharts && W.Highcharts.error(16, !0), W.Highcharts = P(W))
    ...
    P(k, "Core/Utilities.js",
        ...
        function(f) {
            ...
            function x(a, b) {
                var v = {};
                m(a, function(L, p) {
                    if (H(a[p], !0) && !a.nodeType && b[p]) L = x(a[p], b[p]), Object.keys(L).length && (v[p] = L);
                    else if (H(a[p]) || a[p] !== b[p]) v[p] = a[p]
                });
                return v
            }
            ...
            function M(a, b, v, L) {
                ...
                var p = f.defaultOptions.lang,
                    ...
                    h = b;
                if (-1 === b) b = Math.min(K, 20);
                else if (!l(b)) b = 2;
                else if (b && e[1] && 0 > e[1]) {
                    var u = b + +e[1];
                    0 <= u ? (e[0] = (+e[0]).toExponential(u).split("e")[0], b = u) : (e[0] = e[0].split(".")[0] || 0, a = 20 > b ? (e[0] * Math.pow(10,
                        e[1])).toFixed(b) : 0, e[1] = 0)
                }
            ...
            function z(a, b) {
                ...
                for (a = v.pop();
                    "undefined" !== typeof a && "undefined" !== typeof b && null !==
                    b;) b = b[a], a = v.pop();
                return b
            }
            ...
            function r(a, b, v) {
                ...
                function p(p) {
                    ...
                    if (a.nodeName) {
                        ...
                        m(v, function(a, b) {
                            if (p[b])
                                for (u = p[b].length; u--;) e(b, p[b][u].fn)
                        })
                    }
                }
                ...
                format: function(a,
                    ...
                    for (v = v && v.numberFormatter || M; a;) {
                        ...
                        if (p) {
                            g = g.split(":");
                            e = z(g.shift() || "", b);
                            if (g.length && "number" === typeof e)
                                if (g = g.join(":"), h.test(g)) {
    ...
    P(k, "Core/Renderer/HTML/AST.js", [k["Core/Globals.js"],
        k["Core/Utilities.js"]
    ], function(f, d) {
        var k = f.SVG_NS,
            x = d.attr,
        ...
        return function() {
            ...
            E.filterUserAttributes = function(g) {
                t(g, function(y, c) {
                    var q = !0; - 1 === E.allowedAttributes.indexOf(c) && (q = !1); - 1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(c) && (q = H(y) && E.allowedReferences.some(function(c) {
                        return 0 ===
                            y.indexOf(c)
                    }));
            ...
            E.prototype.addToDOM = function(g) {
                function y(c, g) {
                    ...
                    C(c).forEach(function(c) {
                        ...
                        if (q)
                            if ("#text" === q) var m = A;
                            else if (-1 !== E.allowedTags.indexOf(q)) {
                            q = f.doc.createElementNS("svg" === q ? k : g.namespaceURI || k, q);
                            var r = c.attributes || {};
                            t(c, function(e, h) {
                                "tagName" !==
                                h && "attributes" !== h && "children" !== h && "textContent" !== h && (r[h] = e)
                            });
            ...
            E.prototype.parseMarkup = function(g) {
                var y = [];
                if (l) g = (new DOMParser).parseFromString(g, "text/html");
                else {
                    var c = B("div");
                    c.innerHTML = g;
                    g = {
        ...
        d = function() {
            ...
            d.prototype.init = function(f) {
                ...
                if ((this.input = f = d.names[f && f.toLowerCase ? f.toLowerCase() : ""] || f) && f.stops) this.stops = f.stops.map(function(l) {
                    ...
                    if (f && f.charAt && "#" === f.charAt()) {
                        ...
                        7 === C ? k = [(f & 16711680) >> 16, (f & 65280) >> 8, f & 255, 1] : 4 === C && (k = [(f & 3840) >> 4 | (f & 3840) >> 8, (f & 240) >>
                            4 | f & 240, (f & 15) << 4 | f & 15, 1
                        ])
                    }
                    if (!k)
                        for (t = this.parsers.length; t-- && !k;) {
            ...
            d.prototype.brighten = function(d) {
                ...
                if (this.stops) this.stops.forEach(function(C) {
                    ...
                    for (f = 0; 3 > f; f++) t[f] += B(255 * d), 0 > t[f] && (t[f] = 0), 255 < t[f] && (t[f] = 255);
                return this
            };
            ...
            d.prototype.tweenTo = function(d, f) {
                var t = this.rgba,
                    C = d.rgba;
                C.length && t && t.length ? (d = 1 !== C[3] || 1 !== t[3], f = (d ? "rgba(" : "rgb(") + Math.round(C[0] + (t[0] - C[0]) * (1 - f)) + "," + Math.round(C[1] + (t[1] - C[1]) * (1 - f)) + "," + Math.round(C[2] + (t[2] - C[2]) * (1 - f)) + (d ? "," + (C[3] + (t[3] - C[3]) * (1 -
                    f)) : "") + ")") : f = d.input || "none";
                return f
            };
            d.names = {
    ...
    P(k, "Core/Animation/Fx.js", [k["Core/Globals.js"], k["Core/Utilities.js"]], function(f, d) {
        ...
        d = function() {
            ...
            d.prototype.update = function() {
                ...
                else d.attr ? d.element && d.attr(f, t, null, !0) : d.style[f] = t + this.unit;
                C && C.call(d, t, this)
            };
            d.prototype.run =
                function(f, H, t) {
                    ...
                    f !== H || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date, this.start = f, this.end = H, this.unit = t, this.now = this.start, this.pos = 0, E.elem = this.elem, E.prop = this.prop, E() && 1 === d.timers.push(E) && g(y)) : (delete l.curAnim[this.prop], l.complete && 0 === Object.keys(l.curAnim).length &&
    ...
    P(k, "Core/Animation/AnimationUtilities.js",
        [k["Core/Animation/Fx.js"], k["Core/Globals.js"], k["Core/Utilities.js"]],
        function(f, d, k) {
            var x = k.defined,
                B = k.getStyle,
                S = k.isArray,
            ...
            return {
                animate: function(c, g, n) {
                    ...
                    n.easing = "function" === typeof n.easing ? n.easing : Math[n.easing] ||
                        Math.easeInOutSine;
                    n.curAnim = t(g);
                    C(g, function(e, h) {
                        y(c, h);
    ...
    P(k, "Core/Renderer/SVG/SVGElement.js", [k["Core/Animation/AnimationUtilities.js"], k["Core/Renderer/HTML/AST.js"], k["Core/Color/Color.js"], k["Core/Globals.js"],
        k["Core/Color/Palette.js"], k["Core/Utilities.js"]
    ], function(f, d, k, x, B, G) {
        var D = f.animate,
            H = f.animObject,
            t = f.stop,
            C = x.deg2rad,
        ...
        f = function() {
            ...
            f.prototype.attr = function(a,
                ...
                var K = this.element,
                    v, u = this,
                    c, h, g = this.symbolCustomAttribs;
                ...
                "string" === typeof a ? u = (this[a + "Getter"] || this._defaultGetter).call(this, a, K) : (O(a, function(b, p) {
                    ...
                    c || (h = this[p + "Setter"] || this._defaultSetter, h.call(this, b, p, K), !this.styledMode && this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(p) &&
                        this.updateShadows(p, b, h))
            ...
            f.prototype.complexColor =
                function(a, b, p) {
                    var K = this.renderer,
                        v, c, u, g, I, m, L, w, n, r, q = [],
                        F;
            ...
            f.prototype.css = function(a) {
                ...
                if (v) {
                    ...
                    if (a)
                        ...
                        else if ("text" === e.nodeName.toLowerCase() && a.width) var h = this.textWidth = N(a.width);
                    this.styles = a;
                    ...
                    if (e.namespaceURI === this.SVG_NS) {
                        ...
                        O(a, function(a, b) {
                            -1 === u.indexOf(b) && (c += b.replace(/([A-Z])/g, g) + ":" +
                                a + ";")
                        });
                        c && n(e, "style", c)
                    } else M(e, a);
            ...
            f.prototype.dashstyleSetter = function(a) {
                ...
                if (a = a && a.toLowerCase()) {
                    var p = a.replace("shortdashdotdot", "3,1,1,1,1,1,").replace("shortdashdot", "3,1,1,1").replace("shortdot", "1,1,").replace("shortdash", "3,1,").replace("longdash", "8,3,").replace(/dot/g, "1,3,").replace("dash", "4,3,").replace(/,$/,
                        "").split(",");
            ...
            f.prototype.destroy = function() {
                ...
                if (a.clipPath && c) {
                    ...
                    [].forEach.call(c.querySelectorAll("[clip-path],[CLIP-PATH]"), function(a) {
                        -1 < a.getAttribute("clip-path").indexOf(h.element.id) &&
            ...
            f.prototype.getBBox = function(b, e) {
                ...
                if (!p) {
                    ...
                    c.isSVG && (b = p.width, c = p.height, v && (p.height = c = {
                        "11px,17": 14,
                        "13px,20": 16
                    } [g && g.fontSize + "," + Math.round(c)] || c), e && (g = e * C, p.width = Math.abs(c * Math.sin(g)) + Math.abs(b * Math.cos(g)), p.height = Math.abs(c *
                        Math.cos(g)) + Math.abs(b * Math.sin(g))));
                    if (w && 0 < p.height) {
            ...
            f.prototype.setTextPath = function(a, e) {
                ...
                if (a && e && e.enabled) {
                    ...
                    if (v)
                        for (c.setAttribute("y", 0), b(I.dx) && c.setAttribute("x", -I.dx), a = [].slice.call(c.childNodes), v = 0; v < a.length; v++) {
                            var n =
                                a[v];
            ...
            f.prototype.shadow = function(a, b, p) {
                ...
                I && (I && u && O(I, function(a, b) {
                    ...
                    this.destroyShadows(), this.oldShadowOptions = I);
                if (!I) this.destroyShadows();
                    ...
                    for (g = 1; g <= I.width; g++) {
                        ...
                        p && (n(w, "height", Math.max(n(w, "height") - L, 0)),
                            w.cutHeight = L);
            ...
            f.prototype.strokeWidth = function() {
                ...
                var a = this.getStyle("stroke-width"),
                    b = 0;
                if (a.indexOf("px") === a.length - 2) b = N(a);
                else if ("" !== a) {
            ...
            f.prototype.titleSetter = function(a) {
                ...
                b.insertBefore ? b.insertBefore(p,
                    b.firstChild) : b.appendChild(p);
            ...
            f.prototype.updateShadows = function(a, b, p) {
                var e = this.shadows;
                if (e)
                    for (var c = e.length; c--;) p.call(e[c], "height" === a ? Math.max(b - (e[c].cutHeight || 0), 0) : "d" === a ? this.d : b, a, e[c])
            };
            ...
            f.prototype.zIndexSetter = function(a, b) {
                ...
                var g = this.added;
                var I;
                z(a) ? (h.setAttribute("data-z-index", a), a = +a, this[b] === a && (g = !1)) : z(this[b]) &&
                    h.removeAttribute("data-z-index");
                this[b] = a;
                if (g) {
                    ...
                    for (I = b.length - 1; 0 <= I && !u; I--) {
                        ...
                        var m = !z(g);
                        if (e !== h)
                            if (0 > a && m && !p && !I) c.insertBefore(h, b[I]), u = !0;
                            else if (N(g) <= a || m && (!z(a) || 0 <= a)) c.insertBefore(h, b[I + 1] || null), u = !0
                    }
        ...
        f.prototype.matrixSetter = f.prototype.rotationOriginXSetter =
            f.prototype.rotationOriginYSetter = f.prototype.rotationSetter = f.prototype.scaleXSetter = f.prototype.scaleYSetter = f.prototype.translateXSetter = f.prototype.translateYSetter = f.prototype.verticalAlignSetter = function(a, b) {
                this[b] = a;
                this.doTransform = !0
            };
        x.SVGElement = f;
    ...
    P(k, "Core/Renderer/SVG/SVGLabel.js", [k["Core/Renderer/SVG/SVGElement.js"], k["Core/Utilities.js"]], function(f, d) {
        ...
        return function(d) {
            ...
            l.prototype.on = function(g, l) {
                ...
                if (n) {
                    var d = function(q) {
                        ("mouseenter" === g || "mouseleave" === g) && q.relatedTarget instanceof
                        Element && (c.element.compareDocumentPosition(q.relatedTarget) & Node.DOCUMENT_POSITION_CONTAINED_BY || n.element.compareDocumentPosition(q.relatedTarget) & Node.DOCUMENT_POSITION_CONTAINED_BY) || l.call(c.element, q)
                    };
                    n.on(g, d)
                }
            ...
            l.prototype.updateBoxSize =
                function() {
                    ...
                    this.needsBox && (this.box || (g = this.box = this.symbolKey ? this.renderer.symbol(this.symbolKey) : this.renderer.rect(), g.addClass(("button" ===
                        this.className ? "" : "highcharts-label-box") + (this.className ? " highcharts-" + this.className + "-box" : "")), g.add(this)), g = this.getCrispAdjust(), d.x = g, d.y = (this.baseline ? -this.baselineOffset : 0) + g, d.width = Math.round(this.width), d.height = Math.round(this.height), this.box.attr(G(d, this.deferredAttr)), this.deferredAttr = {})
                };
            l.prototype.updateTextPadding = function() {
                ...
                B(this.widthSetting) && this.bBox &&
                    ("center" === this.textAlign || "right" === this.textAlign) && (c += {
                        center: .5,
                        right: 1
    ...
    P(k, "Core/Renderer/SVG/TextBuilder.js",
        [k["Core/Globals.js"], k["Core/Utilities.js"], k["Core/Renderer/HTML/AST.js"]],
        function(f, d, k) {
            var x = f.doc,
                B = f.SVG_NS,
                S = d.attr,
            ...
            return function() {
                ...
                d.prototype.buildSVG = function() {
                    ...
                    if (M !== l.textCache) {
                        ...
                        c || this.ellipsis || this.width || -1 !== f.indexOf(" ") && (!this.noWrap || A.test(f)) ? "" !== f && (g && g.appendChild(d), f = new k(f), this.modifyTree(f.nodes), f.addToDOM(l.element),
                        ...
                        var c = function(c, q) {
                                ...
                                if (d.ellipsis) n && d.truncate(c, n, void 0, 0, Math.max(0, y - parseInt(d.fontSize || 12, 10)), function(a, b) {
                                    ...
                                    for (; l.length;) l.length &&
                                        !d.noWrap && 0 < e && (n.push(c.textContent || ""), c.textContent = l.join(" ").replace(/- /g, "-")), d.truncate(c, void 0, l, 0 === e ? h || 0 : 0, y, function(a, b) {
                            ...
                            q = function(g) {
                                [].slice.call(g.childNodes).forEach(function(n) {
                                    n.nodeType === Node.TEXT_NODE ? c(n,
                                        g) : (-1 !== n.className.baseVal.indexOf("highcharts-br") && (f.actualWidth = 0), q(n))
                                })
                            };
                        q(f.element)
                    }
                    ...
                    var l = this,
                        g = function(f,
                            ...
                            var q = f.tagName,
                                ...
                                A = f.attributes || {};
                            if ("b" === q || "strong" === q) n ? A["class"] = "highcharts-strong" : A.style = "font-weight:bold;" + (A.style || "");
                            else if ("i" === q || "em" === q) n ? A["class"] = "highcharts-emphasized" : A.style = "font-style:italic;" + (A.style || "");
                ...
                d.prototype.truncate = function(d, f, g, y, c, q) {
                    var n = this.svgElement,
                        ...
                        h, a = function(a, b) {
                            b = b || a;
                            var e = d.parentNode;
                            if (e && "undefined" === typeof z[b])
                                if (e.getSubStringLength) try {
                                    z[b] = y + e.getSubStringLength(0, g ? b + 1 : b)
                                } catch (F) {
                                    ""
                                } else l.getSpanWidth && (d.textContent =
                                    q(f || g, a), z[b] = y + l.getSpanWidth(n, d));
                            return z[b]
                        };
                    n.rotation = 0;
    ...
    P(k, "Core/Renderer/SVG/SVGRenderer.js",
        [k["Core/Color/Color.js"], k["Core/Globals.js"], k["Core/Color/Palette.js"], k["Core/Renderer/SVG/SVGElement.js"], k["Core/Renderer/SVG/SVGLabel.js"], k["Core/Renderer/HTML/AST.js"], k["Core/Renderer/SVG/TextBuilder.js"], k["Core/Utilities.js"]],
        function(f, d, k, x, B, G, D, H) {
            var t = H.addEvent,
                C = H.attr,
                l = H.createElement,
                E = H.css,
            ...
            var F = d.SVG_NS,
                ...
                Q, T = function() {
                    ...
                    d.prototype.init = function(a, p, e, c, h, u, g) {
                        ...
                        c = K.element;
                        a.appendChild(c);
                        C(a, "dir", "ltr"); - 1 === a.innerHTML.indexOf("xmlns") && C(c, "xmlns", this.SVG_NS);
                        this.isSVG = !0;
                        this.box = c;
                        this.boxWrapper = K;
                        this.alignedObjects = [];
                    ...
                    d.prototype.symbol = function(a, p, e, w, d, u) {
                        ...
                        if (r) {
                            "number" ===
                            typeof p && (J = r.call(this.symbols, Math.round(p || 0), Math.round(e || 0), w || 0, d || 0, u));
                            var f = this.path(J);
                    ...
                    d.prototype.text = function(a, b, e, c) {
                        var p = {};
                        if (c && (this.allowHTML || !this.forExport)) return this.html(a,
                            b, e);
                        p.x = Math.round(b || 0);
                        e && (p.y = Math.round(e));
                        g(a) && (p.text = a);
            ...
            T.prototype.symbols = {
                ...
                callout: function(a, b, e, c, h) {
                    ...
                    var m = [
                        ["M", a + p, b],
                        ["L", a + e - p, b],
                        ["C", a + e, b, a + e, b, a + e, b + p],
                        ["L", a + e, b + c - p],
                        ["C", a + e, b + c, a + e, b + c, a + e - p, b + c],
                        ["L", a + p, b + c],
                    ...
                    if (!n(g)) return m;
                    a +
                        g >= e ? h > b + u && h < b + c - u ? m.splice(3, 1, ["L", a + e, h - 6], ["L", a + e + 6, h], ["L", a + e, h + 6], ["L", a + e, b + c - p]) : m.splice(3, 1, ["L", a + e, c / 2], ["L", g, h], ["L", a + e, c / 2], ["L", a + e, b + c - p]) : 0 >= a + g ? h > b + u && h < b + c - u ? m.splice(7, 1, ["L", a, h + 6], ["L", a - 6, h], ["L", a, h - 6], ["L", a, b + p]) : m.splice(7, 1, ["L", a, c / 2], ["L", g, h], ["L", a, c / 2], ["L", a, b + p]) : h && h > c && g > a + u && g < a + e - u ? m.splice(5, 1, ["L", g + 6, b + c], ["L", g, b + c + 6], ["L", g - 6, b + c], ["L", a + p, b + c]) : h && 0 > h && g > a + u && g < a + e - u && m.splice(1, 1, ["L", g - 6, b], ["L", g, b - 6], ["L", g + 6, b], ["L", e - p, b]);
                    return m
                }
            };
            d.SVGRenderer =
        ...
        E(x.prototype, {
            ...
            html: function(f, c, q) {
                ...
                n.textSetter = function(c) {
                    c !== this.textStr && (delete this.bBox,
                        delete this.oldTextWidth, d.setElementHTML(this.element, g(c, "")), this.textStr = c, n.doTransform = !0)
                };
    ...
    P(k, "Core/Time.js", [k["Core/Globals.js"], k["Core/Utilities.js"]], function(f, d) {
        ...
        d = function() {
            ...
            d.prototype.update = function(c) {
                ...
                this.timezoneOffset =
                    (this.useUTC = g) && c.timezoneOffset;
                this.getTimezoneOffset = this.timezoneOffsetFunction();
            ...
            d.prototype.timezoneOffsetFunction =
                function() {
                    var c = this,
                        g = this.options,
                        d = g.moment || k.moment;
            ...
            d.prototype.dateFormat = function(c, g, d) {
                var n;
                if (!x(g) || isNaN(g)) return (null === (n = f.defaultOptions.lang) || void 0 === n ? void 0 :
                    n.invalidDate) || "";
                c = l(c, "%Y-%m-%d %H:%M:%S");
                var q = this;
                n = new this.Date(g);
            ...
            d.prototype.getTimeTicks = function(c, d, n, f) {
                ...
                if (x(d)) {
                    q.set("Milliseconds",
                        r, e >= g.second ? 0 : h * Math.floor(q.get("Milliseconds", r) / h));
                    ...
                    d = r.getTime();
                    for (r = 1; d < n;) A.push(d), d = e === g.year ? q.makeTime(b + r * h, 0) : e === g.month ? q.makeTime(b, f + r * h) : !a || e !== g.day && e !== g.week ? a && e === g.hour && 1 < h ? q.makeTime(b, f, w, J + r * h) : d + e * h : q.makeTime(b, f, w + r * h * (e === g.day ? 1 : 7)),
                        r++;
                    A.push(d);
    ...
    P(k, "Core/Axis/Tick.js", [k["Core/Globals.js"], k["Core/Utilities.js"]], function(f, d) {
        ...
        d = function() {
            ...
            d.prototype.addLabel = function() {
                ...
                n = d.labelFormatter.call(c.formatCtx,
                    this.formatCtx);
            ...
            d.prototype.getPosition = function(c, g, d, f) {
                ...
                c = {
                    ...
                    y: c ? m - n.bottom + n.offset -
                        (n.opposite ? n.height : 0) : B(m - n.translate(g + d, null, null, f) - n.transB)
                };
                c.y = x(c.y, -1E5, 1E5);
            ...
            d.prototype.getLabelPosition = function(c, g, d, f, l, z, m, r) {
                var e = this.axis,
                    ...
                    F = {};
                G(n) || (n = 0 === e.side ? d.rotation ? -8 : -d.getBBox().height : 2 === e.side ? w.y + 8 : Math.cos(d.rotation * k) *
                    (w.y - d.getBBox(!1, 0).height / 2));
            ...
            d.prototype.handleOverflow =
                function(c) {
                    ...
                    var r = this.label,
                        ...
                        J = 1,
                        O, F = {};
                    if (e || "justify" !== g(f.overflow, "justify")) 0 > e && l - h * a < m ? O = Math.round(l / Math.cos(e * k) - m) : 0 < e && l + h * a > z && (O = Math.round((t - l) / Math.cos(e * k)));
                    else if (t = l + (1 - h) * a, l - h *
                        a < m ? w = c.x + w * (1 - h) - m : t > z && (w = z - c.x + w * h, J = -1), w = Math.min(b, w), w < b && "center" === d.labelAlign && (c.x += J * (b - w - h * (b - Math.min(a, w)))), a > w || d.autoRotation && (r.styles || {}).width) O = w;
            ...
            d.prototype.moveLabel = function(c, g) {
                ...
                f && f.textStr === c ? (d.movedLabel = f, q = !0, delete d.label) : E(l.ticks, function(e) {
                    q || e.isNew || e === d || !e.label || e.label.textStr !==
                        c || (d.movedLabel = e.label, q = !0, e.labelPos = d.movedLabel.xy, delete e.label)
                });
                if (!q && (d.labelPos || f)) {
            ...
            d.prototype.renderGridLine = function(c, d, f) {
                var n = this.axis,
                    ...
                    J = q[b + "LineColor"];
                q = q[b + "LineDashStyle"];
                l || (n.chart.styledMode || (m.stroke = J, m["stroke-width"] = w, q && (m.dashstyle = q)), e || (m.zIndex = 1), c && (d = 0), this.gridLine = l = a.path().attr(m).addClass("highcharts-" +
                    (e ? e + "-" : "") + "grid-line").add(n.gridGroup));
            ...
            d.prototype.renderMark = function(c, d, f) {
                ...
                q = q[r + "Color"];
                e && (n.opposite && (e[0] = -e[0]), a && (this.mark = h = l.path().addClass("highcharts-" + (m ? m + "-" : "") + "tick").add(n.axisGroup),
            ...
            d.prototype.renderLabel = function(c, d, f, l) {
                ...
                var a = !0,
                    b = c.x;
                c = c.y;
                r && C(b) && (r.xy = c = this.getLabelPosition(b, c, r, q, e, n, l, h), this.isFirst && !this.isLast && !g(m.showFirstLabel, 1) || this.isLast && !this.isFirst && !g(m.showLastLabel, 1) ? a = !1 : !q || e.step ||
                    e.rotation || d || 0 === f || this.handleOverflow(c), h && l % h && (a = !1), a && C(c.y) ? (c.opacity = f, r[this.isNewLabel ? "attr" : "animate"](c), this.isNewLabel = !1) : (r.attr("y", -9999), this.isNewLabel = !0))
            };
    ...
    P(k, "Core/Axis/Axis.js", [k["Core/Animation/AnimationUtilities.js"], k["Core/Color/Color.js"], k["Core/Globals.js"], k["Core/Color/Palette.js"], k["Core/Options.js"], k["Core/Axis/Tick.js"], k["Core/Utilities.js"]], function(f, d, k, x, B, G, D) {
        ...
        f = function() {
            ...
            f.prototype.init = function(a, b) {
                ...
                b = p.options.events; - 1 === a.axes.indexOf(p) && (e ? a.axes.splice(a.xAxis.length, 0, p) :
                    a.axes.push(p), a[p.coll].push(p));
                p.series = p.series || [];
            ...
            f.prototype.defaultLabelFormatter = function() {
                ...
                var n = this.chart,
                    q = n.numberFormatter;
                if (w) var r = m(w, this, n);
                else if (g) r = "" + this.value;
                else if (u) r = c.dateFormat(u, e);
                else if (f && 1E3 <= b)
                    for (; f-- && "undefined" === typeof r;) c = Math.pow(h, f + 1), b >= c && 0 === 10 * e % c && null !==
                        d[f] && 0 !== e && (r = q(e / c, -1) + d[f]);
                ...
                z(this, "getSeriesExtremes", null, function() {
                    ...
                    b.series.forEach(function(p) {
                        if (p.visible || !e.options.chart.ignoreHiddenSeries) {
                            ...
                            } else if (p = p.applyExtremes(), a(p.dataMin) && (d = p.dataMin, b.dataMin = Math.min(F(b.dataMin, d), d)), a(p.dataMax) && (f = p.dataMax, b.dataMax = Math.max(F(b.dataMax, f), f)), c(h) && (b.threshold = h), !u.softThreshold ||
                                b.positiveValuesOnly) b.softThreshold = !1
                        }
                    })
                });
            ...
            f.prototype.getPlotLinePath = function(b) {
                ...
                var c = this,
                    ...
                    w = b.lineWidth,
                    n = b.force,
                    r, q, l, J, v = d && p.oldChartHeight || p.chartHeight,
                ...
                z(this, "getPlotLinePath", b, function(b) {
                    ...
                    b.path = Z && !n ? null : p.renderer.crispLine([
                        ["M", r, q],
                        ["L", l, J]
                    ], w || 1)
                });
            ...
            f.prototype.getMinorTickPositions = function() {
                ...
                if (h && h / e < this.len / 3) {
                    ...
                    else if (this.dateTime && "auto" === this.getMinorTickInterval()) c = c.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(e), g, u, a.startOfWeek));
                    else
                        for (a = g + (b[0] - g) % e; a <= u && a !== c[0]; a += e) c.push(a)
                }
            ...
            f.prototype.adjustForMinRange = function() {
                ...
                this.isXAxis && "undefined" === typeof this.minRange &&
                    !g && (c(a.min) || c(a.max) ? this.minRange = null : (this.series.forEach(function(a) {
                        f = a.xData;
            ...
            f.prototype.nameToX = function(a) {
                ...
                c(g) || (g = !1 === this.options.uniqueNames ? a.series.autoIncrement() :
                    b ? p.indexOf(a.name) : F(p.keys[a.name], -1));
                if (-1 === g) {
                    if (!b) var u = p.length
                } else u = g;
            ...
            f.prototype.setAxisTranslation = function() {
                ...
                if (m || d || c) {
                    ...
                    h ? (g = h.minPointOffset, u = h.pointRangePadding) : a.series.forEach(function(e) {
                        ...
                        c = Math.max(c, p);
                        if (!a.single ||
                            d) e = e.is("xrange") ? !m : m, g = Math.max(g, e && b(h) ? 0 : p / 2), u = Math.max(u, e && "on" === h ? 0 : p)
                    });
            ...
            f.prototype.setTickInterval = function(b) {
                ...
                e.adjustForMinRange();
                !(q || e.axisPointRange || e.stacking && e.stacking.usePercentage || d) && c(e.min) && c(e.max) && (p = e.max -
                    e.min) && (!c(N) && m && (e.min -= p * m), !c(O) && f && (e.max += p * f));
                ...
                a(e.min) && a(e.max) &&
                    !this.chart.polar && e.min > e.max && (c(e.options.min) ? e.max = e.min : c(e.options.max) && (e.min = e.max));
                ...
                h && !b && e.series.forEach(function(a) {
                    var b, c;
                    a.processData(e.min !== (null === (b = e.old) || void 0 === b ? void 0 : b.min) || e.max !== (null ===
                        (c = e.old) || void 0 === c ? void 0 : c.max))
                });
            ...
            f.prototype.setTickPositions = function() {
                ...
                this.single = this.min === this.max && c(this.min) &&
                ...
                !e && (this.ordinal && this.ordinal.positions || !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)) ? e = this.dateTime ? this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, a.units), this.min, this.max, a.startOfWeek, this.ordinal && this.ordinal.positions, this.closestPointRange, !0) : this.logarithmic ? this.logarithmic.getLogTickPositions(this.tickInterval, this.min, this.max) :
                    this.getLinearTickPositions(this.tickInterval, this.min, this.max) : (e = [this.min, this.max], A(19, !1, this.chart)), e.length > this.len && (e = [e[0], e.pop()], e[0] === e[1] && (e.length = 1)), this.tickPositions = e, g && (g = g.apply(this, [this.min, this.max]))) && (this.tickPositions = e = g);
            ...
            f.prototype.setScale = function() {
                ...
                this.setAxisSize();
                (h = this.len !== (null === (a = this.old) || void 0 === a ? void 0 : a.len)) || d || f || this.isLinked || this.forceRedraw || this.userMin !== (null === (b = this.old) || void 0 === b ? void 0 : b.userMin) ||
            ...
            f.prototype.setExtremes = function(a,
                b, e, c, g) {
                var h = this,
                    p = h.chart;
                e = F(e, !0);
            ...
            f.prototype.zoom = function(a, b) {
                ...
                z(this, "zoom", a, function(a) {
                    var b = a.newMin,
                        p = a.newMax;
                    if (b !== e.min || p !== e.max) e.allowZoomOutside || (c(g) && (b < d && (b = d), b > f && (b = f)), c(h) && (p < d && (p = d),
                        p > f && (p = f))), e.displayBtn = "undefined" !== typeof b || "undefined" !== typeof p, e.setExtremes(b, p, !1, void 0, {
                        trigger: "zoom"
                    });
                    a.zoomed = !0
                });
            ...
            f.prototype.setAxisSize = function() {
                ...
                b = this.left = Math.round(N(F(b.left,
            ...
            f.prototype.getThreshold = function(a) {
                ...
                null ===
                    a || -Infinity === a ? a = e : Infinity === a ? a = b : e > a ? a = e : b < a && (a = b);
            ...
            f.prototype.unsquish = function() {
                var a = this.options.labels,
                    ...
                    r, l = Math.max(this.max - this.min, 0),
                    q = function(a) {
                        var b = a / (h || 1);
                        b = 1 < b ? Math.ceil(b) : 1;
            ...
            f.prototype.renderUnsquish = function() {
                ...
                if (this.autoRotation) q > w && q > r.h ? n.rotation = this.labelRotation : this.labelRotation = 0;
                else if (m) {
                    var J = w;
                    if (!l) {
                        var F = "clip";
                ...
                c.forEach(function(a) {
                    var b = (a = g[a]) && a.label,
                        e = d.width,
                        c = {};
                    b && (b.attr(n), a.shortenLabel ?
                        a.shortenLabel() : J && !e && "nowrap" !== d.whiteSpace && (J < b.textPxLength || "SPAN" === b.element.tagName) ? (c.width = J + "px", l || (c.textOverflow = b.specificTextOverflow || F), b.css(c)) : b.styles && b.styles.width && !c.width && !e && b.css({
                            width: null
            ...
            f.prototype.addTitle =
                function(a) {
                    var b = this.chart.renderer,
                        e = this.horiz,
                        c = this.opposite,
                        g = this.options.title,
                        h, d = this.chart.styledMode;
            ...
            f.prototype.getOffset = function() {
                ...
                b.renderLine();
                b.offset = Z * F(h.offset, V[w] ? V[w] + (h.margin ||
                    0) : 0);
            ...
            f.prototype.getLinePath = function(a) {
                ...
                return b.renderer.crispLine([
                    ["M", g ? this.left : h, g ? c : this.top],
                    ["L", g ? b.chartWidth - this.right : h, g ? c : b.chartHeight - this.bottom]
                ], a)
            };
            ...
            f.prototype.renderTick = function(a, b) {
                ...
                if (!this.isLinked || a >= this.min && a <= this.max || (null === (e = this.grid) || void 0 === e ? 0 : e.isColumn)) c[a] || (c[a] = new G(this, a)), g && c[a].isNew && c[a].render(b,
                    !0, -1), c[a].render(b)
            };
            f.prototype.render = function() {
                ...
                f && F && (g = b.getTitlePosition(), a(g.y) ? (f[f.isNew ? "attr" : "animate"](g), f.isNew = !1) : (f.attr("y",
                    -9999), f.isNew = !0));
            ...
            f.prototype.hasVerticalPanning = function() {
                var a, b = null === (a = this.chart.options.chart) || void 0 === a ? void 0 : a.panning;
    ...
    P(k, "Core/Axis/LogarithmicAxis.js", [k["Core/Axis/Axis.js"],
        k["Core/Utilities.js"]
    ], function(f, d) {
        var k = d.addEvent,
            x = d.getMagnitude,
            ...
            D = function() {
                ...
                d.prototype.getLogTickPositions = function(d, f, l, k) {
                    ...
                    if (.5 <= d) d = Math.round(d), q = g.getLinearTickPositions(d, f, l);
                    else if (.08 <= d) {
                        c = Math.floor(f);
                        var n, A;
                        for (y = .3 < d ? [1, 2, 4] : .15 < d ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; c < l + 1 && !A; c++) {
                            var t = y.length;
                            for (n = 0; n < t && !A; n++) {
                                var z = this.log2lin(this.lin2log(c) *
                                    y[n]);
    ...
    P(k, "Core/Axis/PlotLineOrBand.js", [k["Core/Axis/Axis.js"], k["Core/Globals.js"],
        k["Core/Color/Palette.js"], k["Core/Utilities.js"]
    ], function(f, d, k, x) {
        var B = x.arrayMax,
            G = x.arrayMin,
        ...
        x = function() {
            ...
            c.prototype.render = function() {
                ...
                C.zIndex = R;
                x += "-" + R;
                (t = d.plotLinesAndBandsGroups[x]) || (d.plotLinesAndBandsGroups[x] = t = v.g("plot-" +
                    x).attr(C).add());
                ...
                else if (b) F = d.getPlotBandPath(h, e, z);
                else return;
        ...
        C(f.prototype, {
            ...
            removePlotBandOrLine: function(c) {
                for (var g =
                        this.plotLinesAndBands, d = this.options, f = this.userOptions, l = g.length; l--;) g[l].id === c && g[l].destroy();
    ...
    P(k, "Core/Tooltip.js", [k["Core/Globals.js"], k["Core/Color/Palette.js"], k["Core/Utilities.js"]], function(f,
        d, k) {
        var x = f.doc,
            B = k.clamp,
            G = k.css,
        ...
        var M = function() {
            ...
            z.prototype.defaultFormatter = function(c) {
                ...
                e.push(c.tooltipFooterHeaderFormatter(g[0],
                    !0));
                return e
            };
            ...
            z.prototype.getAnchor = function(c, g) {
                ...
                var a = e.inverted,
                    ...
                    l, r;
                c = q(c);
                this.followPointer && g ? ("undefined" === typeof g.chartX && (g = d.normalize(g)),
                    d = [g.chartX - f, g.chartY - b]) : c[0].tooltipPos ? d = c[0].tooltipPos : (c.forEach(function(c) {
                    l = c.series.yAxis;
                    r = c.series.xAxis;
                    m += c.plotX || 0;
            ...
            z.prototype.getLabel = function() {
                ...
                if (!this.label) {
                    if (this.outside) {
                        ...
                        G(q, {
                            ...
                            zIndex: Math.max((null ===
                                (e = this.options.style) || void 0 === e ? void 0 : e.zIndex) || 0, ((null === t || void 0 === t ? void 0 : t.zIndex) || 0) + 3)
                        });
                    ...
                    b && (this.applyFilter(), this.label.addClass("highcharts-tooltip-" +
                        this.chart.index));
            ...
            z.prototype.getPosition = function(g, d, e) {
                var h = this.chart,
                    ...
                    r = n ? Math.max(x.body.scrollHeight,
                        x.documentElement.scrollHeight, x.body.offsetHeight, x.documentElement.offsetHeight, x.documentElement.clientHeight) : h.chartHeight,
                    ...
                    y = k("y"),
                    v = k("x"),
                    t = !this.followPointer && c(e.ttBelow,
                        !h.inverted === !!e.negative),
                    p = function(e, c, g, d, h, m, p) {
                        ...
                        else if (l) b[e] = Math.min(p - d, 0 > J - f ? J : J - f);
                        else if (r) b[e] = Math.max(m, h + f + g > c ? h : h + f);
                        else return !1
                    },
            ...
            z.prototype.move = function(c, g, e, d) {
                ...
                t(b, {
                    x: h ? (2 * b.x + c) / 3 : c,
                    y: h ? (b.y + g) / 2 : g,
                    anchorX: f ? void 0 : h ? (2 * b.anchorX + e) /
                        3 : e,
            ...
            z.prototype.refresh = function(g, f) {
                ...
                if (h.enabled) {
                    ...
                    var N = r[1];
                    !b || a.series &&
                        a.series.noSharedTooltip ? b = a.getLabelConfig() : (e.pointer.applyInactiveState(a), a.forEach(function(a) {
                            a.setState("hover");
                    ...
                    }), g.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" +
                        c(a.colorIndex, n.colorIndex)), l || g.attr({
            ...
            z.prototype.renderSplit = function(m, n) {
                    ...
                    if (!1 !== b && "" !== b) {
                        ...
                        E || r.css(C.style).shadow(C.shadow).attr({
                            stroke: C.borderColor ||
                                g.color || F.color || d.neutralColor80
                        });
                        b = m.tt = r;
                        J = b.getBBox();
                ...
                m = h.container;
                a = h.renderer;
                h.outside && m && a && (b = u.getBBox(), a.setSize(b.width + b.x, b.height + b.y, !1), r = r.getChartPosition(),
            ...
            z.prototype.drawTracker = function() {
                if (this.followPointer || !this.options.stickOnContact) this.tracker && this.tracker.destroy();
                    ...
                    if (g && e) {
                        ...
                        d.height = 0 >
                            e[1] ? Math.max(Math.abs(e[1]), a.height - Math.abs(e[1])) : Math.max(Math.abs(e[1]), a.height);
            ...
            z.prototype.tooltipFooterHeaderFormatter =
                function(c, g) {
    ...
    P(k, "Core/Pointer.js", [k["Core/Color/Color.js"], k["Core/Globals.js"], k["Core/Color/Palette.js"], k["Core/Tooltip.js"], k["Core/Utilities.js"]], function(f, d, k, x, B) {
        ...
        f = function() {
            ...
            f.prototype.drag = function(e) {
                ...
                if (!y || !y.touch)
                    if (b < m ? b = m : b > m + q && (b = m + q), g < l ? g = l : g > l + r && (g = l + r), this.hasDragged = Math.sqrt(Math.pow(v - b, 2) + Math.pow(t - g, 2)), 10 < this.hasDragged) {
                        var A = c.isInsidePlot(v -
                            m, t - l);
            ...
            f.prototype.getChartPosition = function() {
                ...
                2 < a && 2 < e && (this.chartPosition.scaleX = c.width /
                    a, this.chartPosition.scaleY = c.height / e);
            ...
            f.prototype.getHoverData = function(e, g, a, b, d, f) {
                ...
                w = w ? [g] : a.filter(function(a) {
                    return l.filter ?
                        l.filter(a) : a.visible && !(!d && a.directTouch) && z(a.options.enableMouseTracking, !0) && a.stickyTracking
                });
            ...
            f.prototype.onContainerMouseDown =
                function(e) {
            ...
            f.prototype.onContainerMouseEnter =
                function(e) {
            ...
            f.prototype.onContainerTouchMove =
                function(e) {
            ...
            f.prototype.reset = function(e, c) {
                ...
                if (e) f && h && m(h).length && (f.refresh(h), f.shared && d ? d.forEach(function(a) {
                    ...
                    a.crosshair && g.series[a.coll] ===
                        a && a.drawCrosshair(null, g)
                })));
                else {
                    if (g) g.onMouseOut();
            ...
            f.prototype.runPointActions = function(e, c) {
                ...
                h = this.getHoverData(f, h, a.series, (!e ||
                    "touchmove" !== e.type) && (!!c || h && h.directTouch && this.isDirectTouch), g, e);
                f = h.hoverPoint;
                var m = h.hoverPoints;
            ...
            f.prototype.touch = function(e, c) {
                ...
                if (1 === e.touches.length)
                    if (e =
                        this.normalize(e), (b = a.isInsidePlot(e.chartX - a.plotLeft, e.chartY - a.plotTop)) && !a.openMenu) {
    ...
    P(k, "Core/MSPointer.js", [k["Core/Globals.js"], k["Core/Pointer.js"], k["Core/Utilities.js"]], function(f, d, k) {
        ...
        var G = this && this.__extends || function() {
                ...
                return function(g, d) {
                    ...
                    c(g, d);
                    g.prototype = null ===
                        d ? Object.create(d) : (f.prototype = d.prototype, new f)
                }
            }(),
            D = f.charts,
            H = f.doc,
    ...
    P(k, "Core/Series/Point.js", [k["Core/Renderer/HTML/AST.js"], k["Core/Animation/AnimationUtilities.js"], k["Core/Globals.js"], k["Core/Options.js"],
        k["Core/Utilities.js"]
    ], function(f, d, k, x, B) {
        var G = d.animObject,
            D = x.defaultOptions,
        ...
        d = function() {
            ...
            a.prototype.applyOptions = function(b, c) {
                ...
                "undefined" === typeof this.x &&
                    e && (this.x = "undefined" === typeof c ? e.autoIncrement(this) : c);
                return this
            };
            a.prototype.destroy = function() {
                ...
                g && g.enabled ? (this.animateBeforeDestroy(), r(a, h.duration)) :
                    a();
                d.pointCount--
            };
            ...
            a.prototype.optionsToObject = function(b) {
                var e = {},
                    ...
                    m = 0,
                    l = 0;
                if (n(b) || null === b) e[f[0]] = b;
                else if (c(b))
                    for (!d && b.length > h && (g = typeof b[0], "string" === g ? e.name = b[0] : "number" === g && (e.x = b[0]), m++); l < h;) d && "undefined" ===
                        typeof b[m] || (0 < f[l].indexOf(".") ? a.prototype.setNestedProperty(e, b[m], f[l]) : e[f[l]] = b[m]), m++, l++;
                else "object" === typeof b && (e = b, b.dataLabels && (g._hasPointLabels = !0), b.marker && (g._hasPointMarkers = !0));
                return e
            };
            a.prototype.resolveColor = function() {
                ...
                a.options.colorByPoint ? (e || (c = a.options.colors || a.chart.options.colors, this.color = this.color || c[a.colorCounter],
            ...
            a.prototype.update = function(a, c, e, g) {
                function b() {
                    ...
                    A(a, !0) && (h && h.element && a && a.marker && "undefined" !== typeof a.marker.symbol && (d.graphic = h.destroy()), a && a.dataLabels && d.dataLabel && (d.dataLabel =
                        d.dataLabel.destroy()), d.connector && (d.connector = d.connector.destroy()));
                    l = d.index;
            ...
            a.prototype.select = function(a, c) {
                ...
                b.firePointEvent(a ? "select" : "unselect", {
                    ...
                    c || g.getSelectedPoints().forEach(function(a) {
                        var c = a.series;
                        a.selected && a !== b && (a.selected = a.options.selected = !1, c.options.data[c.data.indexOf(a)] = a.options, a.setState(g.hoverPoints && c.options.inactiveOtherPoints ? "inactive" : ""),
            ...
            a.prototype.setState = function(a, c) {
                var b = this.series,
                    ...
                    p = b.chart,
                    k = b.halo,
                    y, t = d && b.markerAttribs;
                a = a || "";
                if (!(a === this.state && !c || this.selected && "select" !== a || !1 ===
                        g.enabled || a && (q || h && !1 === n.enabled) || a && w.states && w.states[a] && !1 === w.states[a].enabled)) {
                    this.state = a;
        ...
        var e = function() {
            ...
            e.prototype.colorizeItem = function(a, b) {
                ...
                if (!this.chart.styledMode) {
                    ...
                    f && (l && f.isMarker && (n = a.pointAttribs(), b || (n.stroke = n.fill =
                        h)), f.attr(n))
                }
            ...
            e.prototype.positionItem = function(a) {
                ...
                }, E(m.translateY) ? m.animate(g, void 0,
                    d) : (m.attr(g), d()));
                h && (h.x = e, h.y = f)
            };
            ...
            e.prototype.renderTitle = function() {
                var a = this.options,
                    ...
                    c = a.title,
                    e = 0;
                c.text && (this.title || (this.title = this.chart.renderer.label(c.text, b -
            ...
            e.prototype.renderItem = function(a) {
                ...
                n || (a.legendGroup = c.g("legend-item").addClass("highcharts-" + p.type + "-series highcharts-color-" + a.colorIndex + (y ? " " + y : "") + (q ? " highcharts-series-" +
                    a.index : "")).attr({
                    zIndex: 1
            ...
            e.prototype.render =
                function() {
                    ...
                    var h = a.spacingBox.width - 2 * f - d.x; - 1 < ["rm", "lm"].indexOf(this.getAlignment().substring(0, 2)) && (h /= 2);
            ...
            e.prototype.handleOverflow = function(a) {
                var b = this,
                    ...
                    d = g.y,
                    f = this.padding;
                d = c.spacingBox.height + ("top" === g.verticalAlign ?
                    -d : d) - f;
                var h = g.maxHeight,
                    m, n = this.clipRect,
                    l = g.navigation,
                ...
                "horizontal" !== g.layout || "middle" ===
                    g.verticalAlign || g.floating || (d /= 2);
                h && (d = Math.min(d, h));
                k.length = 0;
                a > d && !1 !== l.enabled ? (this.clipHeight = m = Math.max(d - 20 - this.titleHeight - f, 0), this.currentPage = M(this.currentPage, 1), this.fullHeight = a, u.forEach(function(a, b) {
                    ...
                    c !== y && (y = c)
                }), n || (n = b.clipRect = e.clipRect(0, f, 9999,
                    0), b.contentGroup.clip(n)), t(m), r || (this.nav = r = e.g().attr({
                    zIndex: 1
            ...
            e.prototype.setItemEvents = function(a, b, e) {
                ...
                (e ? [b, a.legendSymbol] : [a.legendGroup]).forEach(function(e) {
                    if (e) e.on("mouseover", function() {
                        ...
                        a.firePointEvent ? a.firePointEvent("legendItemClick", b, e) : c(a, "legendItemClick",
                            b, e)
                    })
                })
            };
        ...
        var g = f.animate,
            ...
            ca = function() {
                ...
                f.prototype.getArgs = function(a, b, c) {
                    S(a) || a.nodeName ? (this.renderTo = a, this.init(b, c)) : this.init(a,
                        b)
                };
                f.prototype.init = function(a, b) {
                    var c, e = a.series,
                ...
                f.prototype.redraw = function(a) {
                    ...
                    if (r)
                        for (a = e.length; a--;) p = e[a], p.options.stacking && (p.isDirty = !0);
                ...
                f.prototype.layOutTitles = function(a) {
                    ...
                    !this.isDirtyBox && g && (this.isDirtyBox = this.isDirtyLegend =
                        g, this.hasRendered && I(a, !0) && this.isDirtyBox && this.redraw())
                };
                ...
                f.prototype.temporaryDisplay = function(a) {
                    var c = this.renderTo;
                    if (a)
                        for (; c && c.style;) c.hcOrigStyle &&
                            (b(c, c.hcOrigStyle), delete c.hcOrigStyle), c.hcOrigDetached && (n.body.removeChild(c), c.hcOrigDetached = !1), c = c.parentNode;
                    else
                        for (; c && c.style;) {
                ...
                f.prototype.getContainer = function() {
                    ...
                    if (this.styledMode)
                        for (u in g.defs) this.renderer.definition(g.defs[u]);
                ...
                f.prototype.setChartSize = function(a) {
                    ...
                    this.plotHeight = n = Math.max(0, Math.round(g -
                        u - this.marginBottom));
                ...
                f.prototype.drawChartBox = function() {
                    ...
                    if (h) var z = p = g.strokeWidth();
                        ...
                        if (z || g["stroke-width"]) u.stroke =
                            a.borderColor, u["stroke-width"] = z;
                    ...
                    v = "animate";
                    f || (v = "attr", this.plotBorder =
                        f = b.rect().addClass("highcharts-plot-border").attr({
                            zIndex: 1
                        }).add());
                    h || f.attr({
                ...
                f.prototype.propFromSeries = function() {
                    ...
                    ["inverted", "angular", "polar"].forEach(function(f) {
                        ...
                        for (g = e && e.length; !d && g--;)(c = m[e[g].type]) &&
                            c.prototype[f] && (d = !0);
                        a[f] = d
                    })
                };
                ...
                f.prototype.render = function() {
                    ...
                    this.drawChartBox();
                    this.hasCartesianSeries ? d(a) : b && b.length &&
                        d(b);
                ...
                f.prototype.update = function(a, b, c, e) {
                    ...
                    if (f = a.chart) {
                        ...
                        "alignTicks" in f && (q = !0);
                        aa(f, function(a, b) {
                            -1 !== g.propsRequireUpdateSeries.indexOf("chart." + b) && (m = !0); - 1 !== g.propsRequireDirtyBox.indexOf(b) && (g.isDirtyBox = !0); - 1 !== g.propsRequireReflow.indexOf(b) &&
                                (l ? g.isDirtyBox = !0 : u = !0)
                        });
                    ...
                    aa(a, function(b, c) {
                        if (g[c] && "function" === typeof g[c].update) g[c].update(b, !1);
                        else if ("function" === typeof g[d[c]]) g[d[c]](b);
                        else "color" !== c && -1 === g.collectionsWithUpdate.indexOf(c) && ba(!0, g.options[c], a[c]);
                ...
                f.prototype.setCaption = function(a,
                    b) {
                ...
                f.prototype.zoom = function(a) {
                    ...
                    !a || a.resetSelection ? (b.axes.forEach(function(a) {
                        ...
                        e[u ? "zoomX" : "zoomY"] && l && (c = f.zoom(a.min,
                            a.max), f.displayBtn && (g = !0))
                    });
                ...
                f.prototype.pan = function(a, c) {
                    ...
                    Q(this, "pan", {
                        ...
                        c.forEach(function(b) {
                            ...
                            c.panningState = w;
                            c.isOrdinal ||
                                (n = b - u, 0 < n && (r += n, u = b), n = r - l, 0 < n && (r = l, u -= n), c.series.length && u !== q.min && r !== q.max && u >= b && r <= l && (c.setExtremes(u, r, !1, !1, {
                                    trigger: "pan"
        ...
        return f.LegendSymbolMixin = {
            ...
            drawLineMarker: function(d) {
                ...
                this.legendLine = l.path([
                    ["M", 0, d],
                    ["L", H, d]
                ]).addClass("highcharts-graph").attr(g).add(E);
                D && !1 !== D.enabled && H && (f = Math.min(x(D.radius, C), C), 0 === this.symbol.indexOf("url") && (D = k(D, {
                        width: t,
                        height: t
                    }), f = 0), this.legendSymbol = D = l.symbol(this.symbol, H / 2 - f, d - f, 2 * f, 2 * f, D).addClass("highcharts-point").add(E),
                    D.isMarker = !0)
            }
        }
    });
    P(k, "Core/Series/Series.js", [k["Core/Animation/AnimationUtilities.js"], k["Core/Globals.js"], k["Mixins/LegendSymbol.js"], k["Core/Options.js"], k["Core/Color/Palette.js"], k["Core/Series/Point.js"], k["Core/Series/SeriesRegistry.js"], k["Core/Renderer/SVG/SVGElement.js"], k["Core/Utilities.js"]], function(f, d, k, x, B, G, D, H, t) {
        ...
        f = function() {
            ...
            d.prototype.setOptions = function(a) {
                ...
                this.tooltipOptions = T(c.tooltip, c.plotOptions.series && c.plotOptions.series.tooltip, c.plotOptions[this.type].tooltip, g.tooltip.userOptions, d.series &&
            ...
            d.prototype.findPointIndex =
                function(a, b) {
                    var c = a.id,
                        e = a.x,
                        g = this.points,
                        d, f = this.options.dataSorting;
                    if (c) var h = this.chart.get(c);
                    ...
                    "undefined" === typeof l && R(e) && (l = this.xData.indexOf(e, b)); - 1 !== l && "undefined" !== typeof l && this.cropped && (l = l >= this.cropStart ? l - this.cropStart : l);
            ...
            d.prototype.updateData =
                function(a, b) {
                    ...
                    a.forEach(function(a, b) {
                        ...
                        this);
                    if (h)
                        for (a = d.length; a--;)(m = d[a]) && !m.touched && m.remove && m.remove(!1, b);
            ...
            d.prototype.setData = function(b, c, e, g) {
                ...
                if (!v) {
                    ...
                    if (p && m > p)
                        if (p = d.getFirstValidPoint(b), R(p))
                            for (e = 0; e < m; e++) r[e] = this.autoIncrement(),
                                k[e] = b[e];
                        else if (F(p))
                        if (w)
                            for (e = 0; e < m; e++) g = b[e], r[e] = g[0], k[e] = g.slice(1, w + 1);
                        else
                            for (y && (t = y.indexOf("x"), I = y.indexOf("y"), t = 0 <= t ? t : 0, I = 0 <= I ? I : 1), e = 0; e < m; e++) g = b[e], r[e] = g[t], k[e] = g[I];
                    else a(12, !1, n);
                    else
                        for (e = 0; e < m; e++) "undefined" !== typeof b[e] && (g = {
                            series: d
            ...
            d.prototype.getProcessedData = function(b) {
                ...
                if (n &&
                    this.sorted && !l && (!m || g > m || this.forceCrop))
                    if (c[g - 1] < u || c[0] > q) c = [], e = [];
                    else if (this.yData && (c[0] < u || c[g - 1] > q)) {
                ...
                for (m = c.length || 1; --m;)
                    if (g = h ? b(c[m]) - b(c[m - 1]) : c[m] - c[m - 1], 0 < g && ("undefined" === typeof k || g < k)) var k = g;
                    else 0 > g && p && (a(15, !1, this.chart), p = !1);
                return {
                    xData: c,
                    yData: e,
                    cropped: r,
            ...
            d.prototype.processData = function(a) {
                var b = this.xAxis;
                if (this.isCartesian && !this.isDirty && !b.isDirty &&
            ...
            d.prototype.generatePoints = function() {
                ...
                for (q = 0; q < m; q++) {
                    ...
                    } else(k = e[r]) || "undefined" === typeof c[r] || (e[r] = k =
                        (new h).init(this, c[r], d[q]));
                    k && (k.index = r, p[q] = k)
                }
                this.options.keys = a;
                if (e && (m !== (g = e.length) || n))
                    for (q = 0; q < g; q++) q !== l || n || (q += m), e[q] && (e[q].destroyElements(), e[q].plotX = void 0);
                this.data = e;
                this.points = p;
            ...
            d.prototype.translate = function() {
                ...
                for (n = 0; n < m; n++) {
                    ...
                    F(Q) && (x = Q[0], E = Q[1], x === w && N.key === M[C].base &&
                        (x = L(R(k) && k, f.min)), f.positiveValuesOnly && 0 >= x && (x = null), A.total = A.stackTotal = H.total, A.percentage = H.total && A.y / H.total * 100, A.stackY = E, this.irregularWidths || H.setOffset(this.pointXOffset || 0, this.barW || 0));
                    ...
                    A.negative = A[t] < (a[t + "Threshold"] || k ||
                        0);
            ...
            d.prototype.getClipBox = function(a,
                b) {
                var c = this.options,
                    e = this.chart,
                    g = e.inverted,
            ...
            d.prototype.setClip = function(a) {
                ...
                if (!1 !== c.clip ||
                    a) this.group.clip(a || d ? m : b.clipRect), this.markerGroup.clip(l), this.sharedClipKey = h;
            ...
            d.prototype.destroy = function(a) {
                ...
                v(b, function(a, b) {
                    a instanceof H && !a.survive && (g = e && "group" === b ? "hide" : "destroy",
                        a[g]())
                });
            ...
            d.prototype.invertGroups = function(a) {
                ...
                var c = this,
                    e = c.chart;
                c.xAxis && (c.eventsToUnbind.push(n(e,
            ...
            d.prototype.plotGroup = function(a, b, c, g, d) {
                ...
                f.addClass("highcharts-" + b + " highcharts-series-" + this.index + " highcharts-" + this.type + "-series " + (e(this.colorIndex) ? "highcharts-color-" + this.colorIndex + " " : "") + (this.options.className || "") + (f.hasClass("highcharts-tracker") ?
            ...
            d.prototype.addPoint = function(a, b, c, e, g) {
                ...
                var r = q.x;
                var k = n.length;
                if (this.requireSorting && r < n[k - 1])
                    for (p = !0; k && n[k - 1] > r;) k--;
                this.updateParallelArrays(q, "splice", k, 0,
                    0);
            ...
            d.prototype.update = function(c, e) {
                ...
                var g = this,
                    ...
                    r = q[h].prototype,
                    k, w = ["eventOptions", "navigatorSeries", "baseSeries"],
                    u = g.finishedAnimating && {
                        animation: !1
                    },
                    y = {};
                p && (w.push("data",
                    "isDirtyData", "points", "processedXData", "processedYData", "xIncrement", "cropped", "_hasPointMarkers", "_hasPointLabels", "nodes", "layout", "mapMap", "mapData", "minY", "maxY", "minX", "maxX"), !1 !== c.visible && w.push("area", "graph"), g.parallelArrays.forEach(function(a) {
                    w.push(a + "Data")
                ...
                if (q[n || h]) {
                    if (f = n !== g.type, g.remove(!1, !1, !1, !0), f)
                        if (Object.setPrototypeOf) Object.setPrototypeOf(g, q[n || h].prototype);
                        else {
    ...
    P(k, "Extensions/ScrollablePlotArea.js", [k["Core/Animation/AnimationUtilities.js"], k["Core/Axis/Axis.js"], k["Core/Chart/Chart.js"], k["Core/Series/Series.js"],
            ...
            if (!this.renderer.forExport) {
                if (f) {
                    if (this.scrollablePixelsX = f = Math.max(0, f - this.chartWidth)) {
                        ...
                        this.plotWidth += f;
                        this.inverted ? (this.clipBox.height += f, this.plotBox.height += f) : (this.clipBox.width += f, this.plotBox.width +=
                            f);
                        var c = {
                            1: {
                                name: "right",
        ...
        k.prototype.applyFixed = function() {
            ...
            q ? (this.fixedDiv = t("div", {
                ...
                top: 0
            }, null, !0), null === (k = this.scrollingContainer) || void 0 === k ? void 0 : k.parentNode.insertBefore(this.fixedDiv, this.scrollingContainer), this.renderTo.style.overflow = "visible", this.fixedRenderer = g = new B.Renderer(this.fixedDiv,
                this.chartWidth, this.chartHeight, null === (c = this.options.chart) || void 0 === c ? void 0 : c.style), this.scrollableMask = g.path().attr({
            ...
            q && (A.scrollPositionX && (this.scrollingContainer.scrollLeft =
                this.scrollablePixelsX * A.scrollPositionX), A.scrollPositionY && (this.scrollingContainer.scrollTop = this.scrollablePixelsY * A.scrollPositionY));
            g = this.axisOffset;
            ...
            t = function() {
                ...
                d.prototype.cleanStacks = function() {
                    if (!this.axis.isXAxis) {
                        if (this.oldStacks) var d = this.stacks =
                            this.oldStacks;
                        D(d, function(d) {
                            D(d, function(g) {
    ...
    P(k, "Extensions/Stacking.js", [k["Core/Axis/Axis.js"],
        k["Core/Chart/Chart.js"], k["Core/Globals.js"], k["Core/Series/Series.js"], k["Core/Axis/StackingAxis.js"], k["Core/Utilities.js"]
    ], function(f, d, k, x, B, G) {
        ...
        var y = function() {
            ...
            c.prototype.setOffset = function(c, d, f, l, k) {
                ...
                m = H(l) && this.getStackBox(n,
                    this, c, l, d, f, m);
                d = this.label;
                f = this.isNegative;
                c = "justify" === g(this.options.overflow, "justify");
                var e = this.textAlign;
                d && m && (k = d.getBBox(), l = d.padding, e = "left" === e ? n.inverted ? -l : l : "right" === e ? k.width : n.inverted && "center" === e ? k.width / 2 : n.inverted ? f ? k.width + l : -l : k.width / 2, f = n.inverted ? k.height / 2 : f ? -l : k.height, this.alignOptions.x = g(this.options.x, 0), this.alignOptions.y = g(this.options.y, 0), m.x -= e, m.y -= f, d.align(this.alignOptions, null, m), n.isInsidePlot(d.alignAttr.x + e - this.alignOptions.x, d.alignAttr.y +
                    f - this.alignOptions.y) ? d.show() : (d.alignAttr.y = -9999, c = !1), c && x.prototype.justifyDataLabel.call(this.axis, d, this.alignOptions, d.alignAttr, k, m), d.attr({
                    x: d.alignAttr.x,
                    y: d.alignAttr.y
            ...
            c.prototype.getStackBox = function(c, g, d, f, l, m, k) {
                ...
                return {
                    x: h ? g ? f - k.right : f - m + k.pos -
                        c.plotLeft : d + c.xAxis[0].transB - c.plotLeft,
        ...
        x.prototype.setStackedPoints = function(c) {
            ...
            if (d && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                ...
                for (F = 0; F < z; F++) {
                    ...
                    v = w[v][x];
                    null !== R ? (v.points[B] = v.points[this.index] = [g(v.cumulative, e)], H(v.cumulative) || (v.base =
                        B), v.touched = b.stacking.stacksTouched, 0 < Q.index && !1 === this.singleStacks && (v.points[B][0] = v.points[this.index + "," + x + ",0"][0])) : v.points[B] = v.points[this.index] = null;
                    ...
                    null !== R && (v.points[B].push(v.cumulative),
                        t[F] = v.cumulative, v.hasValidPoints = !0)
                }
        ...
        x = function(k) {
            ...
            t.prototype.drawGraph = function() {
                ...
                t.forEach(function(c, f) {
                    ...
                    q && !g && (n = {
                        ...
                        }, c[3] ? n.dashstyle = c[3] : "square" !==
                        l.linecap && (n["stroke-linecap"] = n["stroke-linejoin"] = "round"), q[t](n).shadow(2 > f && l.shadow));
            ...
            t.prototype.getGraphPath = function(d, f, k) {
                ...
                d.forEach(function(q, m) {
                    ...
                    q.isNull && !G(f) && 0 < m ? E = !l.connectNulls :
                        q.isNull && !f ? E = !0 : (0 === m || E ? m = [
                            ["M", q.plotX, q.plotY]
                        ] : g.getPointSpline ? m = [g.getPointSpline(d, q, m)] : c ? (m = 1 === c ? [
                            ["L", h.plotX, e]
                        ] : 2 === c ? [
                            ["L", (h.plotX + r) / 2, h.plotY],
                            ["L", (h.plotX + r) / 2, e]
                        ] : [
                            ["L", r, h.plotY]
                        ], m.push(["L", r, e])) : m = [
                            ["L", r, e]
                        ], t.push(q.x), c && (t.push(q.x), 2 === c && t.push(q.x)), n.push.apply(n, m), E = !1)
                });
                n.xMap = t;
            ...
            t.prototype.getZonesGraphs = function(d) {
                this.zones.forEach(function(f, k) {
                    ...
                    this.chart.styledMode ||
                        k.push(f.color || this.color, f.dashStyle || this.options.dashStyle);
                    d.push(k)
                }, this);
                return d
            };
        ...
        x = function(d) {
            ...
            f.prototype.drawGraph = function() {
                ...
                l.forEach(function(d) {
                    ...
                    g.chart.styledMode || (m.fill = C(d[3],
                        G(d[2]).setOpacity(C(c.fillOpacity, .75)).get()));
                    n[k](m);
                    n.startX = f.xMap;
            ...
            f.prototype.getStackPoints = function(d) {
                ...
                if (this.options.stacking) {
                    for (h = 0; h < d.length; h++) d[h].leftNull = d[h].rightNull =
                        void 0, E[d[h].x] = d[h];
                    t(k, function(a, e) {
                    ...
                    c.forEach(function(b, d) {
                        ...
                        if (E[b] && !E[b].isNull) g.push(E[b]), [-1, 1].forEach(function(g) {
                            var f = 1 === g ? "rightNull" : "leftNull",
                                ...
                                l = k[c[d + g]];
                            if (l)
                                for (h = z; 0 <= h && h < r;) n = l.points[h], n || (h === z ? E[b][f] = !0 : a[h] && (q = k[b].points[h]) && (m -= q[1] - q[0])), h += e;
    ...
    P(k, "Series/Spline/SplineSeries.js", [k["Core/Series/SeriesRegistry.js"], k["Core/Utilities.js"]], function(f, d) {
        ...
        d = function(d) {
            ...
            f.prototype.getPointSpline = function(d, f, l) {
                ...
                f = ["C", G(t.rightContX, t.plotX, 0), G(t.rightContY, t.plotY,
    ...
    P(k, "Series/Column/ColumnSeries.js", [k["Core/Animation/AnimationUtilities.js"], k["Core/Color/Color.js"], k["Core/Globals.js"], k["Mixins/LegendSymbol.js"], k["Core/Color/Palette.js"], k["Core/Series/Series.js"], k["Core/Series/SeriesRegistry.js"], k["Core/Utilities.js"]], function(f, d, k, x, B, G, D, H) {
        ...
        H = function(e) {
            function d() {
                var a = null !== e && e.apply(this, arguments) ||
                    this;
            ...
            d.prototype.animate = function(a) {
                ...
                if (a) f.scaleY = .001, a = g(c.toPixels(e.threshold), c.pos, c.pos + c.len), d ? f.translateX = a - c.len : f.translateY = a, b.clipBox && b.setClip(), b.group.attr(f);
                else {
            ...
            d.prototype.getColumnMetrics = function() {
                ...
                !1 === b.grouping ? h = 1 : a.chart.series.forEach(function(b) {
                    var c = b.yAxis,
                        d = b.options;
                    if (b.type === a.type && (b.visible || !a.chart.options.chart.ignoreHiddenSeries) &&
                        e.len === c.len && e.pos === c.pos) {
            ...
            d.prototype.translate = function() {
                ...
                a.points.forEach(function(d) {
                    ...
                    d.shapeArgs = a.crispCol.apply(a,
                        d.isNull ? [E, k, C, 0] : [E, A, C, B])
                })
            };
            ...
            d.prototype.pointAttribs = function(a, b) {
                ...
                if (a && this.zones.length) {
                    var q = a.getZone();
                    f = a.options.color ||
                        q && (q.color || a.nonZonedColor) || this.color;
            ...
            d.prototype.drawPoints = function() {
                ...
                a.points.forEach(function(f) {
                    ...
                    if (M(f.plotY) && null !== f.y) {
                        ...
                        b.styledMode || h[l](a.pointAttribs(f, f.selected && "select")).shadow(!1 !==
                            f.allowShadow && c.shadow, null, c.stacking && !c.borderRadius);
    ...
    P(k, "Series/Scatter/ScatterSeries.js", [k["Series/Column/ColumnSeries.js"], k["Series/Line/LineSeries.js"],
        k["Core/Series/SeriesRegistry.js"], k["Core/Utilities.js"]
    ], function(f, d, k, x) {
        var B = this && this.__extends || function() {
                var d = function(f, l) {
                    d = Object.setPrototypeOf || {
        ...
        f(k.prototype, {
            connectorShapes: {
                fixedOffset: function(d, f, g) {
                    ...
                    f = f.touchingSliceAt;
                    return [
                        ["M", d.x, d.y], g.softConnector ? ["C", d.x + ("left" === d.alignment ? -5 : 5), d.y,
                            2 * l.x - f.x, 2 * l.y - f.y, l.x, l.y
                        ] : ["L", l.x, l.y],
                        ["L", f.x, f.y]
                    ]
                },
        ...
        C = function(d) {
            ...
            f.prototype.drawPoints = function() {
                ...
                this.points.forEach(function(d) {
                    ...
                    d.graphic || (d.graphic = c[d.shapeType](d.shapeArgs).add(d.series.group),
                ...
                c.points.forEach(function(h) {
                    ...
                    if (!h.isNull && a) {
                        ...
                        h.delayedRendering ? (a.setRadialReference(c.center).attr(g).attr(f), d.styledMode || a.attr(b).attr({
                            ...
                            k), h.delayedRendering = !1) : (a.setRadialReference(c.center), d.styledMode || q(!0, m, b), q(!0, m, g, f), a.animate(m));
                        a.attr({
    ...
    P(k, "Core/Series/DataLabels.js", [k["Core/Animation/AnimationUtilities.js"], k["Core/Globals.js"], k["Core/Color/Palette.js"],
        k["Core/Series/Series.js"], k["Core/Series/SeriesRegistry.js"], k["Core/Utilities.js"]
    ], function(f, d, k, x, B, G) {
        ...
        d.distribute = function(c, f, e) {
            ...
            for (c = c.map(function(a) {
                ...
                a = c.length;
                for (b = !1; a--;) 0 < a && c[a - 1].pos + c[a - 1].size > c[a].pos && (c[a - 1].size += c[a].size, c[a - 1].targets = c[a - 1].targets.concat(c[a].targets), c[a - 1].align = .5, c[a - 1].pos + c[a - 1].size > f && (c[a - 1].pos =
                    f - c[a - 1].size), c.splice(a, 1), b = !0)
            }
            m.push.apply(m, l);
            a = 0;
            c.some(function(b) {
        ...
        x.prototype.drawDataLabels = function() {
            function d(a, b) {
                var c = b.filter;
                return c ? (b = c.operator, a = a[c.property], c = c.value, ">" === b && a > c || "<" ===
                    b && a < c || ">=" === b && a >= c || "<=" === b && a <= c || "==" === b && a == c || "===" === b && a === c ? !0 : !1) : !0
            }
            ...
            var A = h.renderer;
            b = f(f(h.options.plotOptions && h.options.plotOptions.series &&
                h.options.plotOptions.series.dataLabels, h.options.plotOptions && h.options.plotOptions[e.type] && h.options.plotOptions[e.type].dataLabels), b);
            ...
            if (y(b) || b.enabled || e._hasPointLabels) {
                ...
                l.forEach(function(c) {
                    ...
                    t.forEach(function(b,
                        ...
                        if (m) {
                        ...
                        }!l || m && C(u) ? m && C(u) && (l ? x.text = u : (c.dataLabels = c.dataLabels || [], l = c.dataLabels[f] = z ? A.text(u, 0, -9999, b.useHTML).addClass("highcharts-data-label") : A.label(u, 0, -9999,
                            ...
                            c.dataLabel.destroy(), c.dataLabels && (1 === c.dataLabels.length ? delete c.dataLabels : delete c.dataLabels[f]), f || delete c.dataLabel, r && (c.connector = c.connector.destroy(), c.connectors && (1 === c.connectors.length ? delete c.connectors : delete c.connectors[f])))
                    })
                })
            }
        ...
        B.pie && (B.pie.prototype.dataLabelPositioners = {
                ...
                f.visible && (a.enabled || f._hasPointLabels) && (g.forEach(function(a) {
                        ...
                        if (k) {
                            ...
                            for (X = 0; X < k; X++) {
                                ...
                                if (a.justify) u = W.justify(e, E, B);
                    ...
                    }), 0 === H(U) || this.verifyDataLabelOverflow(U)) &&
            ...
            }, B.pie.prototype.alignDataLabel =
            f, B.pie.prototype.verifyDataLabelOverflow = function(c) {
                var d = this.center,
                    e = this.options,
                    f = e.center,
                    a = e.minSize || 80,
                    b = null !== e.size;
                if (!b) {
                    if (null !== f[0]) var g = Math.max(d[2] - Math.max(c[1], c[3]), a);
                    else g = Math.max(d[2] - c[1] - c[3], a), d[0] += (c[3] - c[1]) / 2;
        ...
        B.column && (B.column.prototype.alignDataLabel =
            function(d, f, e, g, a) {
                ...
                e.verticalAlign =
                    n(e.verticalAlign, b || m ? "middle" : l ? "top" : "bottom");
        ...
        k(f, "render", function() {
            ...
            (this.yAxis || []).forEach(function(f) {
                f.stacking && f.options.stackLabels &&
                    !f.options.stackLabels.allowOverlap && D(f.stacking.stacks, function(f) {
                        D(f, function(f) {
                            d.push(f.label)
                        })
                    })
        ...
        f.prototype.hideOverlappingLabels = function(d) {
            ...
            for (y = 0; y < k; y++) {
                ...
                for (g = y + 1; g < k; ++g) {
                    ...
                    !A || !B || n === c || 0 === n.newOpacity || 0 === c.newOpacity || B.x >= A.x + A.width || B.x + B.width <= A.x || B.y >= A.y + A.height || B.y + B.height <= A.y || ((n.labelrank < c.labelrank ?
                        n : c).newOpacity = 0)
                }
            }
    ...
    P(k, "Core/Responsive.js", [k["Core/Chart/Chart.js"],
        k["Core/Utilities.js"]
    ], function(f, d) {
        var k = d.find,
            x = d.isArray,
        ...
        f.prototype.setResponsive = function(d, f) {
            ...
            l = l.toString() || void 0;
            l !==
                (c && c.ruleIds) && (c && this.update(c.undoOptions, d, !0), l ? (c = this.currentOptions(f), c.isResponsiveOptions = !0, this.currentResponsive = {
                    ruleIds: l,
                    mergedOptions: f,
                    undoOptions: c
        ...
        f.prototype.currentOptions = function(d) {
            function f(c, d, k, l) {
                var n;
                D(c, function(c, m) {
                    if (!l && -1 < g.collectionsWithUpdate.indexOf(m) && d[m])
                        for (c = t(c), k[m] = [], n = 0; n < Math.max(c.length, d[m].length); n++) d[m][n] && (void 0 === c[n] ? k[m][n] = d[m][n] : (k[m][n] = {}, f(c[n], d[m][n], k[m][n], l + 1)));
    ...
    P(k, "masters/highcharts.src.js", [k["Core/Globals.js"], k["Core/Utilities.js"],
        k["Core/Renderer/HTML/AST.js"], k["Core/Series/Series.js"]
    ], function(f, d, k, x) {
